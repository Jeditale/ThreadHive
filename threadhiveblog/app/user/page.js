        ...
        <div className="bg-[#FAF3B8] dark:bg-[#3A2E2A] min-h-screen">
                    ...
                    <div className="bg-[#FFF8DC] dark:bg-[#5b4e4a] rounded-lg p-5 shadow-lg w-full h-32 max-w-4xl mb-64">
                        <div className="flex flex-col items-center">
                            <div className="w-44 h-44 rounded-full mb-4">
                                ...
                                <img src={user.profilePicture ? base64Pic + user.profilePicture : "/assets/jyn.png"} alt="Profile" className="w-full h-full rounded-full" />
                            </div>
            ...
            <div className="grid grid-cols-6 pt-5">
                ...
                <p className="text-lg pb-4 dark:text-white">โพสต์ทั้งหมด</p>
                    ...
                    <div>
                        {posts.length > 0 ?
                            (posts.map((post, index) => (
                                <div key={index} className="bg-[#FFF8DC] dark:bg-[#5b4e4a] p-6 rounded-lg shadow-lg w-full max-w-4xl mb-6">

                                {/*  ส่วนโปรไฟล์, ชื่อ และวันที่โพสต์ */}
                                <div className="relative flex items-center space-x-3 mb-3">
                                    {/* รูปโปรไฟล์ */}
                                    <img src={user.profilePicture ? base64Pic + user.profilePicture : "/assets/jyn.png"} alt="Profile" className="w-12 h-12 rounded-full" />
                    ...
                    ) : (<p className="bg-[#FFF8DC] dark:bg-[#5b4e4a] p-6 rounded-lg shadow-lg w-full max-w-4xl mb-6 text-center">ไม่พบโพสต์</p>)}
                    </div>
