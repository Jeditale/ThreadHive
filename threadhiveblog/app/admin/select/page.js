        ...
        <div className="bg-[#FAF3B8] dark:bg-[#3A2E2A] min-h-screen">
            ...
            <div className="grid grid-cols-12 gap-4 mt-5 px-10">
                ...
                <div className="col-start-3 col-span-4 flex justify-center">
                    <div className="bg-[#FFF8DC] dark:bg-[#5b4e4a] shadow-lg rounded-2xl p-10 w-full h-min max-w-sm">
                        <div className="flex flex-col items-center">
                            <img src="/assets/profile.png" className="w-36 h-36 mb-5" />
                            <p className="text-2xl mb-5 font-semibold dark:text-white">name_ee</p>
                            <div>
                                <Link href="/admin/select/editProfile" className="bg-[#3A3000] hover:bg-[#2A1C08] text-white shadow-lg rounded-2xl px-6 py-2 mr-2"> 
                                    แก้ไขโปรไฟล์
                                </Link>
                ...
                <div className="col-start-7 col-span-8">
                    <div className="flex justify-between items-center mb-5">
                        <h2 className="text-lg dark:text-white">โพสต์ทั้งหมด</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        {[1, 2, 3, 4, 5, 6].map((post, index) => (
                            <div key={index} className="bg-[#FFF8DC] dark:bg-[#5b4e4a] shadow-lg rounded-2xl p-5">
                                <div className="flex items-center mb-2">
                                    <img src="/assets/profile.png" className="w-10 h-10 rounded-full mr-3" />
                                    <div>
                                        <p className="font-semibold dark:text-white">name_ee</p>
                                        <p className="text-sm text-gray-600 dark:text-white">1 ม.ค. 2568 12:30</p>
                                    </div>
                                    <div>
